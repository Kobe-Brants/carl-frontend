...
export interface ProductCreateOrModifyRequest {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     * @secure
     */
    productUpdate: (productId: string, data: ProductCreateOrModifyRequest, params: RequestParams = {}) =>
      this.request<ProductResponse, any>({
        path: `/api/Product/${productId}`,
        method: 'PUT',
        body: data,
     ...
     * @tags Product
     * @name ProductDelete
     * @request DELETE:/api/Product/{productId}
     * @secure
     */
    ...
    productList: (
      ...
      this.request<ProductResponsePagedResult, any>({
        path: `/api/Product`,
        method: 'GET',
        query: query,
        secure: true,
     ...
     * @secure
     */
    productCreate: (data: ProductCreateOrModifyRequest, params: RequestParams = {}) =>
      this.request<ProductResponse, any>({
        path: `/api/Product`,
        method: 'POST',
        body: data,
